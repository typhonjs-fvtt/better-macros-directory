...
// the dev server.
const s_PACKAGE_ID = 'modules/better-macros-directory';
...
// ATTENTION!
// Please modify the above variables: s_PACKAGE_ID and s_SVELTE_HASH_ID appropriately.
      ...
      plugins: [
         svelte({
            compilerOptions: {
               ...
               // 'better-macros-directory'. This is reasonable to do as the styles in TRL compiled across `n` different
               // packages will be the same. Slightly modifying the hash ensures that your package has uniquely scoped
               // styles for all TRL components.
